...
function getdata($con) {
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        <td>
        <button class="btn btn-danger my-3" type="submit" name="rejectpelamar" style="cursor:pointer; id="'.$row['id'].'" onclick="liat('.$row['id'].')">Reject</button>
        </td>
        <td>
        <button class="btn btn-warning my-3" type="submit" name="acceptpelamar" style="cursor:pointer; id="'.$row['id'].'" onclick="acc('.$row['id'].')">Accept</button>
        </td>
        </tr>
        ';
    }
