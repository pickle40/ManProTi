...
function getdata($con) {
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        <td>'.$row['Tgl_Lamar'].'</td>
        <td>
        <button class="btn btn-success my-3" type="submit" name="infopelamar" style="cursor:pointer; id="'.$row['id'].'" onclick="liat('.$row['id'].')">Info</button>
        </td>
        <td>
        <a href="#" type="button" class="btn btn-danger my-3" data-toggle="modal" data-target="#ModalDelete'.$row['id'].'">Reject</a>
    </td>
    ...
    <div class="modal-body">
        <center><h4>Are you sure you want to Reject this partcipat?</h4></center>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
        <a type="button" class="btn btn-success" href="save_reject.php?id='.$row['id'].'">Yes</a>
    </div>
        
    
    <td>
        <a href="#" type="button" class="btn btn-success my-3" data-toggle="modal" data-target="#Modalacc'.$row['id'].'">Accept</a>
    </td>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
        <a type="button" class="btn btn-success" href="save_accept_pelamar.php?id='.$row['id'].'">Yes</a>
    </div>
        </tr>
        ';
    }
