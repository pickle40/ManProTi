...
<br>
    <!-- HTML !-->
<button id="gmsk" style="margin-top: 20px;" class="button-12" role="button" data-toggle="modal" data-target="#exampleModal">Ijin tidak masuk</button>
            </div>
        </div>
     </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <button style="float: right;" type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
