...
function getdata($con) {
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        <form role="form" action="save.php" method="get">
...
function gethistory($con) {
  ...
  <?php
    $output = "";
    $count = 0;
    $query = "SELECT id, Nama_Pelatihan, Status, Tgl_Mulai, Tgl_Selesai, Pegawai_id FROM `training`";
    $result = $con->query($query);
...
<br><br>
 ...
 <th>#</th>
      ...
      <th>Absen Pulang</th>
      <th>Alasan</th>
      <th>Total waktu(Minutes)</th>
      <div class="container">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Warning</button>
    <!-- <button type="button" class="btn btn-success my-3" data-toggle="modal" data-target="#mygaji" type="submit" name="gaji" style="cursor:pointer; id="'.$row['pid'].'" onclick="liat('.$row['pid'].')">Gaji</button> -->
    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#mygaji">Gaji</button>
    <div class="modal fade" id="mygaji" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Total waktu kerja dalam menit =</p>
          <?php
            $total = 0;
            echo $total;
          ?>
